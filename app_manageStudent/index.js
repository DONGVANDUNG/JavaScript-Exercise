    ...
    handerClick: function() {
        ...
        btnSave.addEventListener('click', function() {
                ...
                if (inputNull == 0) {
                    ...
                    boxStudent.insertAdjacentHTML("beforeend", `<div class="student-item student-${amountStudent}">
                                                            ...
                                                            <div class="btn-change">
                                                                ...
                                                                <i class="fa-solid fa-ban icon icon-delete icon-hidden"></i>
                                                              </div>
                                                         </div>`)
                    modal.style.display = 'none';
                    formStudent.style.display = 'none'
        ...
        icon_hideStudent.forEach(function(item) {
            item.addEventListener('click', function() {
                const boxDetailInfor = icon_hideStudent.parentElement.parentElement.firstElementChild;
